...
async def get_start_msg_buttons(key=None, query=None):
    ...
    if key is None:
        ...
        button_maker.add_row([('Sᴏᴜʀᴄᴇ ᴄᴏᴅᴇ', 'sbthelp source'), ('ᴅᴇᴠᴇʟᴏᴩᴇʀ 😎', 'sbthelp mydevelopers')])
